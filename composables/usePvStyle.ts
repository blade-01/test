export default () => {
  ...
  const autocompleteStyle = computed(() => {
    return {
      ...
      inputToken: {
        class: "placeholder:font-light placeholder:text-text-secondary",
      },
      panel: {
        class:
          "bg-bg-primary  dropdown-text max-h-[200px] overflow-y-auto w-[250px] xl:w-[350px]",
      },
      header: {
        class: "bg-bg-primary  dropdown-text py-3.5",
      },
      ...
      token:
        "gap-2 inline-flex items-center bg-bg-primary  rounded-full dropdown-token !px-1.5",
      tokenLabel: {
        class: "dropdown-token-label",
      },
      removeTokenIcon: {
  ...
  const dialogStyle = computed(() => {
    return {
      root: {
        class: "bg-bg-primary  dialog rounded-lg shadow-xl border",
      },
      header: {
