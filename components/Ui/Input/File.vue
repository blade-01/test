...
<template>
  ...
  >
    ...
    <div class="relative">
      ...
      <label :for="name">
        <span
          class="input-style font-light !text-text-primary flex gap-2.5"
          :class="{
            '!pl-10': prependIcon
          }"
        >
    ...
    <div class="mt-5" v-if="value">
      ...
      >
        ...
        />
        <span class="input-style font-light !text-secondary" v-else>
          {{ fileName(value) }}
        </span>
        <Icon
          name="mdi:close-circle-outline"
          size="24"
          class="absolute -top-2.5 -right-2.5 text-secondary cursor-pointer"
